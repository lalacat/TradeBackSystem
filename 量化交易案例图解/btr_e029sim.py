...
class ma(bt.Strategy):
    ...
    params = (('period', 30),('fgPrint', False), )
    ...
    def next(self):
        ...
        if not self.position:
            ...
            if self.dataclose[0] > self.sma[0]:
                ...
                self.log('设置买单 SELL CREATE, %.2f, name : %s' % (self.dataclose[0],self.datas[0]._name), fgPrint=True)
...
print('\n\t# 案例当中，使用的是MA均线策略')
cerebro.addstrategy(ma,period=30)
#
